//! # rumycelium-core
//!
//! Core data model for **RuMycelium** — the federated environmental
...
//! simulator (`rumycelium-bench`) — nothing here claims field-validated
//! accuracy.

#![doc(html_root_url = "https://docs.rs/rumycelium-core/0.1.0")]
...
/// Wire spec version for the RuMycelium fabric (ADR-264).
pub const SPEC_VERSION: &str = "rumycelium.fabric.v0.1";
