...
//! and **normalize** the payload into a [`rumycelium_core::EnvSample`].
//!
...
#![doc(html_root_url = "https://docs.rs/rumycelium-ingest/0.1.0")]

use rumycelium_abi::{verify_record, RvEnvSampleV1, SignedEnvRecordV1};
...
mod tests {
    use super::*;
    use rumycelium_abi::{NodeSigner, RV_ENV_FLAG_RETRANSMIT, RV_ENV_SCHEMA_V1};
    use rumycelium_core::SensorModality;

    const SEED: &[u8; 32] = b"rumycelium-provision-seed-32-by!";
