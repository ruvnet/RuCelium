//! # rumycelium-worldgraph
//!
//! The RuMycelium environmental **WorldGraph** (ADR-264 §5.2) and the RuView
...
#![doc(html_root_url = "https://docs.rs/rumycelium-worldgraph/0.1.0")]
