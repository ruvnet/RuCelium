...
//! environmental event above [`rumycelium_core::Severity::Advisory`], and
...
use rumycelium_core::{GeoPoint, SensorModality, Severity};
...
mod tests {
    ...
    use rumycelium_core::SampleProvenance;
    use rumycelium_core::Uncertainty;
