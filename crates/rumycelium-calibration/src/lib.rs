//! # rumycelium-calibration
//!
//! Calibration lineage, calibration application, EWMA drift detection, and
//! sensor quarantine for the RuMycelium fabric (ADR-264 §12).
//!
//! This crate enforces the §12 countermeasures on the gateway side:
//!
//! 1. **Signed calibration lineage** — every [`rumycelium_core::CalibrationRecord`]
...
#![doc(html_root_url = "https://docs.rs/rumycelium-calibration/0.1.0")]
