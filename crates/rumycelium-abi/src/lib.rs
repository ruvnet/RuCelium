//! # rumycelium-abi
//!
//! The versioned C ABI boundary of the RuMycelium fabric (ADR-264 §11).
//!
...
//! record (header of record: [`include/rumycelium_env.h`]); this crate parses
...
//! before conversion into the `rumycelium-core` domain model.
//!
...
//!
//! [`include/rumycelium_env.h`]:
//!     https://github.com/ruvnet/rufield/blob/main/crates/rumycelium-abi/include/rumycelium_env.h

#![doc(html_root_url = "https://docs.rs/rumycelium-abi/0.1.0")]
