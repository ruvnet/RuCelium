/*
 * rumycelium_env.h — RuMycelium spore-node wire contract, version 1
 ...
 *     CBOR (see rumycelium-abi::cbor).
 */

#ifndef RUMYCELIUM_ENV_H
#define RUMYCELIUM_ENV_H
...
/* Sensor modality codes (must match rumycelium_core::SensorModality). */
enum rv_sensor_type {
