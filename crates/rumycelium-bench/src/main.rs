//! `rumycelium-bench` binary — runs the deterministic ADR-264 §14 biome
...
//!   cargo run -p rumycelium-bench -- 2026 --json   # JSON only

use rumycelium_bench::{run, SimConfig, DEFAULT_SEED};
